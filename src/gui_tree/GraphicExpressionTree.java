...
public class GraphicExpressionTree extends JPanel {

	private static final long serialVersionUID = 6993591777476439522L;
	private TreeBB miArbol;
	...
	public GraphicExpressionTree(TreeBB miArbol) {
		this.miArbol = miArbol;
		this.setBackground(Color.WHITE);
		posicionNodos = new HashMap<Nodo, Rectangle>();
		subtreeSizes = new HashMap<Nodo, Dimension>();
		dirty = true;
		repaint();
	}
